-- pig -x local -f sim.pig -param filename=/Users/vera.kalinichenko/Downloads/t/dataset.txt
...
--store result into 'feb6/result1';
--store data into 'feb5/data';
--store itemInManyIdsDistOrd into 'feb5/itemInManyIdsBigDistOrd';